    ...
    (let ((base03    (find-color 'base03))
      ...
      (let ((back base03))
        ...
        `((;; basic
           ...
           ;; Helm
           (helm-action ((t (:weight ,bold))))
           (helm-candidate-number ((t (:foreground ,yellow :background ,back))))
           (helm-selection ((t (:weight ,bold :background ,back :foreground ,green))))
           (helm-separator ((t (:foreground ,red))))
           (helm-source-header ((t (:background ,back :weight ,bold))))
           (helm-visible-mark ((t (:background ,back :foreground ,blue)))))
